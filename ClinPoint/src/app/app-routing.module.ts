...
const routes: Routes = [
  {
    ...
    children :[
      ...
      { path: 'users', component: MapPageComponent, canActivate:[GuardGuard] },
      ...
      { path: 'secretary', component: SchedulerPageComponent, canActivate:[GuardGuard] },
      ...
      { path: 'faq', component: BlockedUserComponent, canActivate:[GuardGuard] },
